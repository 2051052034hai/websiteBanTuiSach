...
{
    public class GioHang_62133881Controller : Controller
    {
        ...
        public ActionResult SuaGioHang(int MaSP)
        {
            ...
            if(Session["GioHang_62133881"] == null)
            {
                return RedirectToAction("Index", "Home_62133881");   //quay về trang chủ
            }
            //ktra sp có tồn tại trong csdl ko
            ...
            if(spCheck == null)
            {
                return RedirectToAction("Index", "Home_62133881");
            }
        ...
        public ActionResult DatHang(KhachHang kh)
        {
            ...
            Session["GioHang_62133881"] = null;  //sau khi thêm vào ddh thì giỏ hàng sẽ trống
            return RedirectToAction("XemGioHang");
        }
        ...
        public List<ItemGioHang> LayGioHang()
        {
            ...
            List<ItemGioHang> lstGioHang = Session["GioHang_62133881"] as List<ItemGioHang>; //lưu giỏ hàng vào session giohang để quản lý
            if (lstGioHang == null)
            {
                //Nếu session giỏ hàng ko tồn tại thì khởi tạo giỏ hàng
                lstGioHang = new List<ItemGioHang>();
                Session["GioHang_62133881"] = lstGioHang;
            }
            return lstGioHang;
        }
        ...
        {
            //lấy giỏ hàng
            List<ItemGioHang> lstGioHang = Session["GioHang_62133881"] as List<ItemGioHang>;
